...
if (!$result) {
    die("Error fetching data from 'fruit': " . mysqli_error($conn));
}
...
<link rel="shortcut icon" href="assets/logo.png" type="image/x-icon">
    <link href="style/showfruitproduct.css" rel="stylesheet">
</head>
...
<script>
    ...
    <div class="productsection" align="center">
        ...
        <div class="col-2">
            <h1 style="color: #ffffff;">Fruits<br></h1>
        </div>
            ...
            <div id="Gents" class="tab-pane fade in active">
                ...
                ?>
                    <div class="product-container">
                        <img src="images/fruit/<?php echo $row["image"]; ?>" class="img-responsive" />
                        <div class="product-details">
                            <h4 style="font-size: 20px;" class="text-danger"><a href="productdetailsfruit.php?id=<?php echo $row["id"]; ?>"><?php echo $row["name"]; ?> - <?php echo $row["details"]; ?></a></h4>
