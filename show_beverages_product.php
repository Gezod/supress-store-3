...
// Fetch data from 'beverages' table
$query = "SELECT * FROM beverages ORDER BY id ASC";
$result = mysqli_query($conn, $query);

if (!$result) {
    die("Error fetching data from 'beverages': " . mysqli_error($conn));
}
session_start();
...
<link rel="shortcut icon" href="assets/logo.png" type="image/x-icon">
    <link href="style/showbeveragesproduct.css" rel="stylesheet">
</head>
...
<body>
    ...
    <div class="category-section">
        <button type="button" class="category-button" onclick="redirectTo('show_fruit_product.php')">
            <img src="assets/fruit.png" alt="Category Image 1">
        </button>

        <button class="category-button" onclick="redirectTo('show_vegetable_product.php')">
            <img src="assets/vegetable.png" alt="Category Image 2">
        </button>
    ...
    <div class="productsection" align="center">
        ...
        <div class="col-2">
            <h1 style="color: #ffffff;">Beverages<br></h1>
        </div>
            ...
            <div id="Gents" class="tab-pane fade in active">
                ...
                ?>
                    <div class="product-container">
                        <img src="images/beverages/<?php echo $row["image"]; ?>" class="img-responsive" />
                        <div class="product-details">
                            <h4 style="font-size: 20px;" class="text-danger"><a href="productdetails1.php?id=<?php echo $row["id"]; ?>"><?php echo $row["name"]; ?> - <?php echo $row["details"]; ?></a></h4>
