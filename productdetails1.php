...
$id = $_GET['id'];
$result = mysqli_query($conn, "SELECT * FROM beverages WHERE id='" . $id . "'");
...
<link rel="shortcut icon" href="assets/logo.png" type="image/x-icon">
    <link href="style/productdetails1.css" rel="stylesheet">
        ...
        <div class="row">
            <div class="col-12 col-md-6">
                <div class="product-image-container">
                    <img src="images/beverages/<?php echo $image; ?>" alt="<?php echo $pname; ?>" class="img-fluid product-image">
                </div>
            </div>
