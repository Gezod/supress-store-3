...
// Fetch data from 'vegetable' table
$query = "SELECT * FROM vegetables ORDER BY id ASC";
$result = mysqli_query($conn, $query);

if (!$result) {
    die("Error fetching data from 'vegetable': " . mysqli_error($conn));
}
...
<link rel="shortcut icon" href="assets/logo.png" type="image/x-icon">
    <link href="style/showvegetablesproduct.css" rel="stylesheet">
</head>
...
<body>
    ...
    <div class="category-section">
        ...
        <button class="category-button" onclick="redirectTo('show_cooking_essentials_product.php')">
            <img src="assets/powder.png" alt="Category Image 3">
        </button>
    </div>
    ...
    <div class="productsection" align="center">
        ...
        <div class="col-2">
            <h1 style="color: #ffffff;">Vegetables<br></h1>
        </div>
            ...
            <div id="Gents" class="tab-pane fade in active">
                ...
                ?>
                    <div class="product-container">
                        <img src="images/vegetable/<?php echo $row["image"]; ?>" class="img-responsive" />
                        <div class="product-details">
                            <h4 style="font-size: 20px;" class="text-danger"><a href="productdetailsvegetable.php?id=<?php echo $row["id"]; ?>"><?php echo $row["name"]; ?> - <?php echo $row["details"]; ?></a></h4>
                            <h4 style="font-size: 20px;" class="text-danger">Rp <?php echo $row["price"]; ?></h4>
                            <input type="number" name="quantity" id="quantity<?php echo $row["id"]; ?>" class="form-control" value="1" style="font-size: 12px;"/>
                            ...
                            <br>
                            <input type="button" name="add_to_cart" id="<?php echo $row["id"]; ?>" class="btn btn-warning form-control add_to_cart" value="Add to Cart" style="font-size: 16px;" />
                        </div>
                    </div>
