...
if (isset($_SESSION['name'])) {
    ...
    $result  = $mysqli->query("SELECT * FROM beverages") or die($mysqli->error);
}
...
<head>
    ...
    <link href="style/crud_beverages.css" rel="stylesheet">
...
<body>
        ...
        <header>
            ...
            <nav>
                ...
                <li><a href="admin_after_loginn.php" >Home</a></li>
                    <li><a href="crud_beverages.php" class="active">Beverage</a></li>
    ...
    <div id="addNewItemModal" class="modal-overlay" style="display: none">
        <div class="modal-content">
            ...
            <form method="post" action="beverages_manage.php" enctype="multipart/form-data">
    ...
    <hr>
    <h1 align="center" style="color: #ddd";>Beverages</h1>
        ...
        <tbody>
            ...
            while ($row = $result->fetch_assoc()) :  ?>
                <tr>
                    ...
                    <td><img width="35px" height="35px" src="images/beverages/<?php echo $row['image']; ?>" </td>
                    ...
                    <!-- Delete button -->
                    <td>
                        <a href="beverages_manage.php?delete=<?php echo $row['id']; ?>" class="delete-button btn btn-danger btn-lg" onclick="return confirm('Are you sure you want to delete this item?')">
                            Delete
                        </a>
                    </td>
                </tr>
    ...
    <div id="editmodal" class="modal" style="display: none; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%);">
        <div class="modal-content">
            <form method="post" action="beverages_update.php" enctype="multipart/form-data">
                <div class="modal-header">
