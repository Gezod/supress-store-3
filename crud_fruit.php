...
if (isset($_SESSION['name'])) {
    ...
    $result  = $mysqli->query("SELECT * FROM fruit") or die($mysqli->error);
}
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Welcome</title>
    <link href="style/crud_fruit.css" rel="stylesheet">
...
<body>
    ...
    <hr>
    <h1 align="center" style="color: #ddd";>Fruits</h1>
        ...
        <tbody>
            ...
            while ($row = $result->fetch_assoc()) :  ?>
                <tr>
                    ...
                    <td><img width="35px" height="35px" src="images/fruit/<?php echo $row['image']; ?>" </td>
                    ...
                    <!-- Delete button -->
                    <td>
                        <a href="fruits_manage.php?delete=<?php echo $row['id']; ?>" class="delete-button btn btn-danger btn-lg" onclick="return confirm('Are you sure you want to delete this item?')">
                            Delete
                        </a>
                    </td>
                </tr>
